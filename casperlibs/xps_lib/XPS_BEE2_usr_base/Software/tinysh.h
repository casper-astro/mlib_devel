...
/* Modified by Pierre-Yves Droz to support Windows consoles and to support the xilinx micro kernel */

typedef void (*tinysh_fnt_t)();
...
extern int ctrlfpga_has_control;
