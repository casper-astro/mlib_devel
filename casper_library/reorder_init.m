...
reuse_block(blk, 'delay_we', 'xbsIndex_r4/Delay', ...
  'latency', num2str(pre_delay), 'Position', [305 50 345 70]);
...
reuse_block(blk, 'pre_sync_delay', 'xbsIndex_r4/Delay', ...
    'Position', [305 0 345 20], 'latency', num2str(pre_delay));
...
reuse_block(blk, 'post_sync_delay', 'xbsIndex_r4/Delay', ...
    'Position', [615  0  655  20], 'latency', num2str(bram_latency+(double_buffer*2)));
...
if order == 1,
    ...
    for cnt=1:n_inputs,
        ...
        % Delays
        reuse_block(blk, ['delay_din', num2str(cnt-1)], 'xbsIndex_r4/Delay', ...
