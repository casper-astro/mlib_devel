...
function bus_single_port_ram_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('data word bit widths|data word binary points|initial value vector|limit fanout to ?|memory type|memory optimization|asynchronous |misc support|bram latency|fanout register latency|addr input register|din input register|we input register|en input register'), ...
		'MaskStyleString', sprintf('edit,edit,edit,edit,popup(Distributed memory|Block RAM),popup(Area|Speed),checkbox,checkbox,edit,edit,checkbox,checkbox,checkbox,checkbox'), ...
		'MaskTabNameString', sprintf('basic,basic,basic,basic,basic,basic,basic,basic,latency,latency,latency,latency,latency,latency'), ...
		'MaskCallbackString', sprintf('|||||||||||||'), ...
		...
		'MaskVariables', sprintf('n_bits=@1;bin_pts=@2;init_vector=@3;max_fanout=@4;mem_type=&5;bram_optimization=&6;async=&7;misc=&8;bram_latency=@9;fan_latency=@10;addr_register=&11;din_register=&12;we_register=&13;en_register=&14;'), ...
		'MaskValueString', sprintf('0|17|[[-2:1/(2^10):2-(1/(2^10))]'']|4|Block RAM|Speed|off|off|2|1|on|on|on|on'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
...
function bus_dual_port_ram_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskDescription', sprintf('RAM for a bus allowing fanout control'), ...
		'MaskPromptString', sprintf('data word bit widths|data word binary points|initial value vector|limit fanout to ?|memory type|memory optimization|a asynchronous |b asynchronous|misc support|bram latency|fanout register latency'), ...
		'MaskStyleString', sprintf('edit,edit,edit,edit,popup(Distributed memory|Block RAM),popup(Area|Speed),checkbox,checkbox,checkbox,edit,edit'), ...
		'MaskTabNameString', sprintf('basic,basic,basic,basic,basic,basic,basic,basic,basic,latency,latency'), ...
		'MaskCallbackString', sprintf('||||||||||'), ...
		...
		'MaskVariables', sprintf('n_bits=@1;bin_pts=@2;init_vector=@3;max_fanout=@4;mem_type=&5;bram_optimization=&6;async_a=&7;async_b=&8;misc=&9;bram_latency=@10;fan_latency=@11;'), ...
		'MaskValueString', sprintf('0|17|[[-2:1/(2^10):2-(1/(2^10))]'']|4|Block RAM|Area|off|off|off|2|1'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
