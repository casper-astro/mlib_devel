...
function bus_dual_port_ram_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskValueString', sprintf('0|17|[[-2:1/(2^10):2-(1/(2^10))]'']|4|Block RAM|Area|off|off|1|off|2|1|off|core|off|core|off|core|off|core|off|core|off|core|off|core|off|core'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
