...
function bus_addsub_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskStyleString', sprintf('edit,edit,edit,edit,edit,edit,edit,checkbox,checkbox,checkbox,edit,edit,edit,edit,edit,edit'), ...
		'MaskTabNameString', sprintf('input,input,input,input,input,input,input,input,input,input,output,output,output,output,output,latency'), ...
		...
		'MaskVariables', sprintf('opmode=@1;n_bits_a=@2;bin_pt_a=@3;type_a=@4;n_bits_b=@5;bin_pt_b=@6;type_b=@7;cmplx=&8;misc=&9;async=&10;n_bits_out=@11;bin_pt_out=@12;type_out=@13;quantization=@14;overflow=@15;latency=@16;'), ...
		'MaskValueString', sprintf('0|0|3|1|4|3|1|on|on|off|8|3|1|0|1|1'), ...
