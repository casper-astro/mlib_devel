...
function bus_single_port_ram_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('data word bit widths|data word binary points|initial value vector|limit fanout to ?|memory type|asynchronous |misc support|bram latency|fanout register latency'), ...
		'MaskStyleString', sprintf('edit,edit,edit,edit,popup(Distributed memory|Block RAM),checkbox,checkbox,edit,edit'), ...
		'MaskTabNameString', sprintf('basic,basic,basic,basic,basic,basic,basic,latency,latency'), ...
		'MaskCallbackString', sprintf('||||||||'), ...
		'MaskEnableString', sprintf('on,on,on,on,on,on,on,on,on'), ...
		'MaskVisibilityString', sprintf('on,on,on,on,on,on,on,on,on'), ...
		'MaskToolTipString', sprintf('on,on,on,on,on,on,on,on,on'), ...
		'MaskVariables', sprintf('n_bits=@1;bin_pts=@2;init_vector=@3;max_fanout=@4;mem_type=&5;async=&6;misc=&7;bram_latency=@8;fan_latency=@9;'), ...
		'MaskValueString', sprintf('0|17|[[-2:1/(2^3):2-(1/(2^3))]'']|4|Block RAM|off|off|2|1'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
...
function bus_maddsub_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('a input bit widths|a input binary points |a input type (Unsigned=0, Signed=1)|b input bit widths|b input binary points|b input type (Unsigned=0, Signed=1)|multiplier latency|multiplier implementation|a and b input replication support|mode|c input bit widths|c input binary points|c input type (Unsigned=0, Signed=1)|adder implementation|adder latency|asynchronous addition|align c path with a and b|c input replication support|output bit widths|output binary points|output type (Unsigned=0, Signed=1)|quantization strategy (Truncate=0, Round  (unbiased: +/- Inf)=1)|overflow strategy (Wrap=0, Saturate=1, Flag as error=2)|convert latency|limit fanout to ?'), ...
		'MaskStyleString', sprintf('edit,edit,edit,edit,edit,edit,edit,popup(behavioral HDL|standard core|embedded multiplier core),checkbox,popup(Addition|Subtraction),edit,edit,edit,popup(behavioral HDL|fabric core|DSP48 core),edit,checkbox,checkbox,checkbox,edit,edit,edit,edit,edit,edit,edit'), ...
		'MaskTabNameString', sprintf('multiplication,multiplication,multiplication,multiplication,multiplication,multiplication,multiplication,multiplication,multiplication,addsub,addsub,addsub,addsub,addsub,addsub,addsub,addsub,addsub,output,output,output,output,output,output,implementation'), ...
		'MaskCallbackString', sprintf('||||||||||||||||||||||||'), ...
		...
		'MaskVariables', sprintf('n_bits_a=@1;bin_pt_a=@2;type_a=@3;n_bits_b=@4;bin_pt_b=@5;type_b=@6;mult_latency=@7;multiplier_implementation=&8;replication_ab=&9;opmode=@10;n_bits_c=@11;bin_pt_c=@12;type_c=@13;add_implementation=&14;add_latency=@15;async_add=&16;align_c=&17;replication_c=&18;n_bits_out=@19;bin_pt_out=@20;type_out=@21;quantization=@22;overflow=@23;conv_latency=@24;max_fanout=@25;'), ...
		'MaskValueString', sprintf('0|7|1|[18 18]|17|1|3|behavioral HDL|on|Addition|[4 4 4 4]|3|0|behavioral HDL|1|on|off|off|26|24|1|0|0|0|2'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
