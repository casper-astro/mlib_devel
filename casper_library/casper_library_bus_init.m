function casper_library_bus_init()
	...
	add_block('built-in/SubSystem', [blk,'/bus_add']);
	bus_add_gen([blk,'/bus_add']);
	set_param([blk,'/bus_add'], ...
		'operation', sprintf('a-b'), ...
		'n_bits_a', sprintf('0'), ...
		'bin_pt_a', sprintf('3'), ...
		'type_a', sprintf('1'), ...
		'n_bits_b', sprintf('4'), ...
...
function bus_add_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskVariables', sprintf('operation=&1;n_bits_a=@2;bin_pt_a=@3;type_a=@4;n_bits_b=@5;bin_pt_b=@6;type_b=@7;cmplx=&8;misc=&9;n_bits_out=@10;bin_pt_out=@11;type_out=@12;quantization=@13;overflow=@14;add_latency=@15;'), ...
		'MaskValueString', sprintf('a-b|0|3|1|4|3|1|on|on|8|3|1|0|1|1'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));

end % bus_add_mask

function bus_add_init(blk)
...
function bus_mult_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('a input bit widths|a input binary points |a input type (Unsigned=0, Signed=1)|a input complex|b input bit widths|b input binary points|b input type (Unsigned=0, Signed=1)|b input complex|output bit widths|output binary points|output type (Unsigned=0, Signed=1)|quantization strategy (Truncate=0, Round  (unbiased: +/- Inf)=1)|overflow strategy (Wrap=0, Saturate=1, Flag as error=2)|multiplier latency|adder latency|limit fanout to ?|fanout register latency|misc support'), ...
		'MaskStyleString', sprintf('edit,edit,edit,checkbox,edit,edit,edit,checkbox,edit,edit,edit,edit,edit,edit,edit,edit,edit,checkbox'), ...
		'MaskTabNameString', sprintf('input,input,input,input,input,input,input,input,output,output,output,output,output,operation,operation,operation,operation,input'), ...
		'MaskCallbackString', sprintf('|||||||||||||||||'), ...
		...
		'MaskVariables', sprintf('n_bits_a=@1;bin_pt_a=@2;type_a=@3;cmplx_a=&4;n_bits_b=@5;bin_pt_b=@6;type_b=@7;cmplx_b=&8;n_bits_out=@9;bin_pt_out=@10;type_out=@11;quantization=@12;overflow=@13;mult_latency=@14;add_latency=@15;max_fanout=@16;fan_latency=@17;misc=&18;'), ...
		'MaskValueString', sprintf('[]|4|1|on|[]|3|1|on|12|7|1|0|0|3|1|0|0|on'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
