...
function bus_convert_mask(blk, varargin)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('input bit widths|input binary points |input types (Unsigned=0, Signed=1)|input complex|output bit widths|output binary points|output type (Unsigned=0, Signed=1)|quantization strategy (Truncate=0, Round  (unbiased: +/- Inf)=1, Round (unbiased: Even Values)=2)|overflow strategy (Wrap=0, Saturate=1, Flag as error=2)|latency|overflow indication|misc support'), ...
		'MaskStyleString', sprintf('edit,edit,edit,checkbox,edit,edit,edit,edit,edit,edit,edit,checkbox'), ...
		'MaskTabNameString', sprintf('input,input,input,input,output,output,output,output,output,operation,operation,input'), ...
		'MaskCallbackString', sprintf('|||||||||||'), ...
		...
		'MaskVariables', sprintf('n_bits_in=@1;bin_pt_in=@2;type_in=@3;cmplx=&4;n_bits_out=@5;bin_pt_out=@6;type_out=@7;quantization=@8;overflow=@9;latency=@10;of=@11;misc=&12;'), ...
		'MaskValueString', sprintf('[]|8|1|off|8|4|1|1|1|2|0|on'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
