...
for i=0:2^(n_inputs-2)-1,
    ...
    reuse_block(blk, name, 'casper_library/FFTs/fft_biplex_real_4x', ...
        'FFTSize', mat2str(FFTSize-n_inputs), 'BitWidth', mat2str(BitWidth), ...
        'add_latency', mat2str(add_latency), 'mult_latency', mat2str(mult_latency), ...
        'bram_latency',mat2str(bram_latency), 'Position', pos);
...
reuse_block(blk, 'slice', 'xbsIndex_r4/Slice', ...
    'mode', 'Lower Bit Location + Width', 'bit0', mat2str(FFTSize-n_inputs), 'nbits', mat2str(n_inputs), ...
