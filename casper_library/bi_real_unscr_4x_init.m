...
reuse_block(blk, 'sync_delay', 'casper_library_delays/sync_delay', ...
    ...
    'LinkStatus', 'inactive', ...
    'ShowName', 'on', ...
    'DelayLen', '2^(FFTSize-1) + add_latency + add_latency + 1');

%
% NOTE: Ignoring conv_latency, and using add_latency instead.
% This ensures that the new block behaves exactly as the old
% block, so all existing unit tests should continue to work.
% At some point, this restriction should probably be removed.
%
...
if strcmp(bram_delays, 'on'),
    ...
    delay_name = 'delay_slr';
    reuse_block(blk, [delay_name, '0'], 'casper_library_delays/delay_slr', ...
        'Position', [650 205 700 225], ...
        'LinkStatus', 'inactive', ...
        'NamePlacement', 'alternate', ...
        'DelayLen', '2^(FFTSize-1)');
    reuse_block(blk, [delay_name, '1'], 'casper_library_delays/delay_slr', ...
        'Position', [650 230 700 250], ...
        'LinkStatus', 'inactive', ...
        'DelayLen', '2^(FFTSize-1)');
end
