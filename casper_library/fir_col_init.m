...
for i=1:n_inputs,
    ...
    reuse_block(blk, ['fir_tap',num2str(i)], 'casper_library_downconverter/fir_tap', ...
        ...
        'factor',num2str(coeff(i)), 'coeff_bit_width', tostring(coeff_bit_width), ...
	'coeff_bin_pt', tostring(coeff_bin_pt));
...
if n_inputs > 1,
    reuse_block(blk, 'adder_tree1', 'casper_library_misc/adder_tree', ...
        ...
        'latency', num2str(add_latency),'first_stage_hdl', adder_tree_hdl);
