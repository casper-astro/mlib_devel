...
%  add_latency                 = get_var('add_latency', 'defaults', defaults, varargin{:});
  ...
  if strcmp(async, 'on'),
    ...
    reuse_block(blk, 'den0', 'xbsIndex_r4/Delay', 'reg_retiming', 'on', ...
      'latency', '1', 'Position', [160 505 195 525]);
    ...
    reuse_block(blk, 'den2', 'xbsIndex_r4/Delay', 'reg_retiming', 'off', 'latency', '0', ...
  ...
  reuse_block(blk, 'ddata0', 'xbsIndex_r4/Register', ...
  ...
  reuse_block(blk, 'ddata1', 'xbsIndex_r4/Register', ...
