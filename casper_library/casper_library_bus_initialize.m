function casper_library_bus_initialize()
	...
	set_param([blk,'/bus_addsub'], ...
		...
		'pipeline_en', sprintf('off'), ...
		'pipeline_latency', sprintf('0'), ...
...
function bus_addsub_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskEnableString', sprintf('on,on,on,on,on,on,on,on,on,on,on,off,off,off,on,on,on,on,on,on,on,on,on'), ...
		'MaskVisibilityString', sprintf('on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on'), ...
		'MaskToolTipString', sprintf('on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on,on'), ...
		'MaskVariables', sprintf('opmode=@1;n_bits_a=@2;bin_pt_a=@3;type_a=@4;n_bits_b=@5;bin_pt_b=@6;type_b=@7;cmplx=&8;misc=&9;async=&10;floating_point=@11;float_type=@12;exp_width=@13;frac_width=@14;n_bits_out=@15;bin_pt_out=@16;type_out=@17;quantization=@18;overflow=@19;add_implementation=&20;csp_latency=@21;pipeline_en=@22;pipeline_latency=@23;'), ...
		'MaskValueString', sprintf('0|0|3|1|4|3|1|on|on|off|off|single|6|19|8|3|1|0|1|fabric core|1|off|0'), ...
...
function bus_mux_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('number of inputs|input bit widths|complex data|misc support|mux latency'), ...
		'MaskStyleString', sprintf('edit,edit,checkbox,checkbox,edit'), ...
		'MaskCallbackString', sprintf('||||'), ...
		'MaskEnableString', sprintf('on,on,on,on,on'), ...
		'MaskVisibilityString', sprintf('on,on,on,on,on'), ...
		'MaskToolTipString', sprintf('on,on,on,on,on'), ...
		'MaskVariables', sprintf('n_inputs=@1;n_bits=@2;cmplx=&3;misc=&4;mux_latency=@5;'), ...
		'MaskValueString', sprintf('0|8|off|off|0'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
...
function bus_mult_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskValueString', sprintf('0|4|1|on|4|3|1|on|on|off|single|1|1|19|6|12|7|1|0|0|3|1|1|2|0|behavioral HDL|off|0'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
...
function bus_negate_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskVariables', sprintf('n_bits_in=@1;bin_pt_in=@2;cmplx=&3;misc=&4;floating_point=@5;float_type=@6;exp_width=@7;frac_width=@8;n_vectors=@9;overflow=@10;csp_latency=@11;'), ...
...
function bus_single_port_ram_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskStyleString', sprintf('edit,edit,edit,edit,popup(Distributed memory|Block RAM|Ultra RAM),popup(Area|Speed),checkbox,checkbox,edit,edit,checkbox,popup(core|behavioral),checkbox,popup(core|behavioral),checkbox,popup(core|behavioral),checkbox,popup(core|behavioral)'), ...
		'MaskCallbackString', sprintf('|||||||||||||||||'), ...
...
function bus_adder_tree_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('number of busses|bus component bit widths|number floating point vectors in bus|bus component binary points|bus component data types|misc support|floating point|float type|fraction width|exponent width|adder latency|implement first stage in of adders in behavioral HDL?|adder implementation '), ...
		'MaskStyleString', sprintf('edit,edit,edit,edit,edit,checkbox,checkbox,radiobutton(single|custom),edit,edit,edit,checkbox,popup(Behavioral|Fabric|DSP48)'), ...
		'MaskCallbackString', sprintf('||||||onoff = get_param(gcb, ''floating_point'');\nif strcmp(onoff,''on'')\n    enable_fixpt = ''off'';\n    set_param_state(gcb, ''float_type'', ''on'')\n    set_param_state(gcb, ''num_float_vec'', ''on'')\n    \n    f_type = get_param(gcb, ''float_type'');\n    if strcmp(f_type,''custom'')\n        set_param_state(gcb, ''exp_width'', ''on'')\n        set_param_state(gcb, ''frac_width'', ''on'')\n    else\n        set_param_state(gcb, ''exp_width'', ''off'')\n        set_param_state(gcb, ''frac_width'', ''off'')\n    end\n    \n    \nelse\n    enable_fixpt = ''on'';\n    set_param_state(gcb, ''float_type'', ''off'')\n    set_param_state(gcb, ''exp_width'', ''off'')\n    set_param_state(gcb, ''frac_width'', ''off'')\n    set_param_state(gcb, ''num_float_vec'', ''off'')\nend\n\nset_param_state(gcb, ''n_bits'', enable_fixpt)\nset_param_state(gcb, ''bin_pts'', enable_fixpt)\nset_param_state(gcb, ''dtypes'', enable_fixpt)\n\n\n|f_type = get_param(gcb, ''float_type'');\nif strcmp(f_type,''custom'')\n    set_param_state(gcb, ''exp_width'', ''on'')\n    set_param_state(gcb, ''frac_width'', ''on'')\nelse\n    set_param_state(gcb, ''exp_width'', ''off'')\n    set_param_state(gcb, ''frac_width'', ''off'')\nend|||||'), ...
		'MaskEnableString', sprintf('on,on,on,on,on,on,on,off,off,off,on,on,on'), ...
		...
		'MaskVariables', sprintf('n_busses=@1;n_bits=@2;num_float_vec=@3;bin_pts=@4;dtypes=@5;misc=&6;floating_point=@7;float_type=@8;frac_width=@9;exp_width=@10;add_latency=@11;first_stage_hdl=&12;adder_imp=&13;'), ...
		'MaskValueString', sprintf('0|8|1|0|0|off|off|single|0|0|1|on|Behavioral'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'));
