...
tap_multipliers = multiplier_specification(mult_spec, TotalTaps, 'pfb_fir_init');
...
% compute the gain and bitgrowth for this pfb
[max_gain bit_growth adder_n_bits_out adder_bin_pt_out] = pfb_bitgrowth_calcs(WindowType, PFBSize, TotalTaps, n_inputs, fwidth, BitWidthIn, CoeffBitWidth);
