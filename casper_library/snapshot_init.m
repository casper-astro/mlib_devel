...
reuse_block(blk, 'cast', 'xbsIndex_r4/Convert', ...
    ...
    'bin_pt', '0', 'quantization', 'Truncate', 'overflow', 'Wrap', 'Latency', '0', ...
...
if ext_circ
    ...
    reuse_block(blk, 'circ', 'xbsIndex_r4/Constant', ...
        'gui_display_data_type', 'Boolean', 'arith_type', 'Boolean', 'const', '0', ...
        'explicit_period', 'on', 'period', '1', 'Position', [110 567 140 583]);
end
add_line(blk, 'circ/1', 'circ_or/2');

% ctrl reg
reuse_block(blk, 'ctrl', 'xps_library/Memory/software_register', ...
...
%         'Position', [180 320 200 340]);
    reuse_block(blk, 'trig_offset', 'xps_library/Memory/software_register', ...
        'io_dir', 'From Processor', 'arith_types', '0', ...
...
if circular_capture == 1
    ...
    % tr_en_cnt register 
    reuse_block(blk, 'tr_en_cnt', 'xps_library/Memory/software_register', ...
...
% status registers
reuse_block(blk, 'status', 'xps_library/Memory/software_register', ...
    'io_dir', 'To Processor', 'arith_types', '0', ...
...
if extra_val
    ...
    % register
    reuse_block(blk, 'val', 'xps_library/Memory/software_register', ...
        'io_dir', 'To Processor', 'arith_types', '0', ...
...
if strcmp(storage, 'dram')
    ...
    % shared BRAM
    reuse_block(blk, 'bram', 'xps_library/Memory/shared_bram', ...
