...
for p = 1 : io_numios
    ...
    reuse_block(blk, assert_name, 'xbsIndex_r4/Assert', ...
            ...
            'gui_display_data_type', gddtype, 'arith_type', type_to_string(io_current_types(p)), ...
            'bin_pt', num2str(io_current_bins(p)), ...
...
if strcmp(snap_value, 'on')
    ...
    for p = 1 : extra_numios
        ...
        reuse_block(blk, assert_name, 'xbsIndex_r4/Assert', ...
            'showname', 'off', 'assert_type', 'on', ...
            'type_source', 'Explicitly', ...
            'gui_display_data_type', gddtype, 'arith_type', type_to_string(extra_current_types(p)), ...
            'bin_pt', num2str(extra_current_bins(p)), ...
