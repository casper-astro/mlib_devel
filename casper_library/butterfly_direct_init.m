...
function butterfly_direct_init(blk, varargin)
  ...
  reuse_block(blk, 'a', 'built-in/Inport', ...
          'Port', sprintf('1'), ...
          'Position', sprintf('[45 63 75 77]'));
  reuse_block(blk, 'b', 'built-in/Inport', ...
          'Port', sprintf('2'), ...
          'Position', sprintf('[45 123 75 137]'));
  reuse_block(blk, 'sync_in', 'built-in/Inport', ...
          'Port', sprintf('3'), ...
          'Position', sprintf('[45 183 75 197]'));
  ...
  if strcmp(async, 'on'),
    reuse_block(blk, 'dvi', 'built-in/Inport', ...
            'Port', sprintf('5'), ...
            'Position', sprintf('[45 243 75 257]'));
  end
  
  reuse_block(blk, 'a+bw', 'built-in/Outport', ...
          'Port', sprintf('1'), ...
          'Position', sprintf('[810 58 840 72]'));
  reuse_block(blk, 'a-bw', 'built-in/Outport', ...
          'Port', sprintf('2'), ...
          'Position', sprintf('[810 88 840 102]'));
  reuse_block(blk, 'of', 'built-in/Outport', ...
          'Port', sprintf('3'), ...
          'Position', sprintf('[810 123 840 137]'));
  reuse_block(blk, 'sync_out', 'built-in/Outport', ...
          'Port', sprintf('4'), ...
          'Position', sprintf('[810 183 840 197]'));
  if strcmp(async, 'on'),
    reuse_block(blk, 'dvo', 'built-in/Outport', ...
            'Port', sprintf('5'), ...
            'Position', sprintf('[810 243 840 257]'));
  end
