function casper_library_downconverter_init()
	...
	set_param([blk,'/cosin'], ...
		...
		'pack', sprintf('off'), ...
		'bram', sprintf('BRAM'), ...
		'Position', sprintf('[180 27 235 63]'));
...
function cosin_mask(blk)
	...
	set_param(blk, ...
		...
		'MaskPromptString', sprintf('first output function|second output function|lookup table size (2^?)|bit width|binary point|misc port|bram latency|large adder latency|mux latency|negate latency|convert latency|fraction of cosine period in lookup|pack lookup values in same output word|BRAM implementation'), ...
		'MaskStyleString', sprintf('popup(sin|cos|-sin|-cos),popup(sin|cos|-sin|-cos),edit,edit,edit,checkbox,edit,edit,edit,edit,edit,popup(quarter|half|full),checkbox,popup(distributed RAM|BRAM)'), ...
		'MaskTabNameString', sprintf('basic,basic,basic,basic,basic,basic,latency,latency,latency,latency,latency,implementation,implementation,implementation'), ...
		'MaskCallbackString', sprintf('|||||||||||||'), ...
		...
		'MaskVariables', sprintf('output0=&1;output1=&2;table_bits=@3;n_bits=@4;bin_pt=@5;misc=&6;bram_latency=@7;add_latency=@8;mux_latency=@9;neg_latency=@10;conv_latency=@11;fraction=&12;pack=&13;bram=&14;'), ...
		'MaskValueString', sprintf('cos|-sin|0|18|17|off|1|1|1|1|3|full|off|BRAM'), ...
		'BackgroundColor', sprintf('[0.501961, 1.000000, 0.501961]'), ...
