...
% Drawing the fixed blocks in the design.Includes the sync delays at the top
    ...
    reuse_block(blk,'sync_delay2','xbsIndex_r4/Delay', ...
                'latency', '2', ...
...
% %  %%%%%%%%%% number of inputs.
 ...
 name = ['Relational_sel', num2str(i)];                
   ...
   reuse_block(blk,name,'xbsIndex_r4/SineCosine',...
               'Position',[875 y1+38+((i-1)*405) 920 y2+27+((i-1)*405)],...        
               'mode', 'Sine and Cosine',...
               'neg_sin','off',...
               'neg_cos', 'off',...
               'n_bits', num2str(sine_cos_bits),...
               'latency', '2',...
               'mem_type', 'Block RAM',...
               'use_rpm', 'on');
...
for i= 1: n_input
    ...
    add_line(blk, ['Logical',num2str(i),'/1'],['Convert',num2str((i*3)-2),'/1'], 'autorouting', 'on');
     ...
     add_line(blk,['c_to_ri',num2str(i),'/1'],['cmult_4bit_hdl',num2str(i),'/1'],'autorouting', 'on');
     add_line(blk,['c_to_ri',num2str(i),'/2'],['cmult_4bit_hdl',num2str(i),'/2'],'autorouting', 'on');
     add_line(blk,['SineCosine',num2str(i),'/2'],['cmult_4bit_hdl',num2str(i),'/3'],'autorouting', 'on');
     add_line(blk,['SineCosine',num2str(i),'/1'],['cmult_4bit_hdl',num2str(i),'/4'],'autorouting', 'on');
 
    
     add_line(blk,['cmult_4bit_hdl',num2str(i),'/1'],['Convert',num2str((i*3)-1),'/1'],'autorouting', 'on');
     add_line(blk,['cmult_4bit_hdl',num2str(i),'/2'],['Convert',num2str(i*3),'/1'],'autorouting', 'on');
