...
%reuse_block(blk, 'x_cast', 'casper_library/Correlator/x_cast', ...
...
%reuse_block(blk, 'xeng_conj_fix', 'casper_library/Correlator/xeng_conj_fix', ...
...
if (n_ants == 4)
    ...
    add_line(blk, 'xeng_descramble_4ant/2', 'valid/2', 'autorouting', 'on');
    add_line(blk, 'xeng_descramble_4ant/3', 'sync_out/3', 'autorouting', 'on');
