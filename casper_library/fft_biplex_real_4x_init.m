...
reuse_block(blk, 'sync_out', 'built-in/outport', 'Position', [535  28 565  42], 'Port', '1');
reuse_block(blk, 'pol1_out', 'built-in/outport', 'Position', [585  53 615  67], 'Port', '2');
reuse_block(blk, 'pol2_out', 'built-in/outport', 'Position', [535  78 565  92], 'Port', '3');
reuse_block(blk, 'pol3_out', 'built-in/outport', 'Position', [585 103 615 117], 'Port', '4');
reuse_block(blk, 'pol4_out', 'built-in/outport', 'Position', [535 128 565 142], 'Port', '5');
reuse_block(blk, 'of', 'built-in/outport', 'Position', [320 138 350 152], 'Port', '6');
...
add_line(blk, 'bi_real_unscr_4x/2', 'pol1_out/1');
add_line(blk, 'bi_real_unscr_4x/3', 'pol2_out/1');
add_line(blk, 'bi_real_unscr_4x/4', 'pol3_out/1');
add_line(blk, 'bi_real_unscr_4x/5', 'pol4_out/1');
