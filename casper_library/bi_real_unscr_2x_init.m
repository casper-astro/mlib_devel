...
if strcmp(async, 'on'), add_line(blk, 'reorder_even/2', 'count/2');
end

reuse_block(blk, 'constant', 'xbsIndex_r4/Constant', ...
    'Position', [240 37 260 53], ...
    'ShowName', 'off', ...
    'arith_type', 'Unsigned', ...
    'const', '0', ...
    'n_bits', 'FFTSize-1', ...
...
add_line(blk, 'reorder_even/3', 'hilbert/1');
