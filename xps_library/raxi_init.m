function raxi_init(blk)

clog(sprintf('entering raxi_init(%s)', blk), 'trace');
check_mask_type(blk, 'raxi');
try
    munge_block(blk);
...
[numios, current_names, current_widths, current_bins, current_types] = raxi_maskcheck(blk);
