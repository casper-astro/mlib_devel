...
if strcmp(get_param(myname, 'use_sim'), 'on')
    ...
    str=[str,'ModelSim'];
    set_param([gcb, '/sim_wrapper/dram_sim'], 'engine_block', 'ModelSim');
    set_param([gcb, '/sim_wrapper/dram_sim'], 'sim_method', 'External co-simulator');
    set_param([gcb, '/sim_wrapper/dram_sim'], 'engine_block', str);
else
    set_param([gcb, '/sim_wrapper/dram_sim'], 'engine_block', 'ModelSim');
    set_param([gcb, '/sim_wrapper/dram_sim'], 'sim_method', 'Inactive');
end
