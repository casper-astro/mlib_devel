...
switch hw_sys
   case 'ROACH'
     ...
     str = [str, ' PORT usr_rst = 0b0',                            '\n'];
     str = [str, ' PORT usr_clk = epb_clk',                        '\n'];
     str = [str, ' PORT clk_in_locked = 0b1',                      '\n'];
     str = [str, ' PORT clk_out = ddr2_user_clk',                  '\n'];
     str = [str, 'END\n'];
     str = [str, '\n'];
   otherwise % case BEE2*
end % switch hw_sys
...
switch hw_sys
   case 'ROACH'
     ...
     str = [str, ' BUS_INTERFACE DDR2_USER = ddr2_ctrl',       '\n'];
     str = [str, ' BUS_INTERFACE DRAM_SYS  = dram_sys',        '\n'];
     str = [str, '#PORT phy_rdy      = phy_rdy',               '\n'];
...
switch hw_sys
   case 'ROACH'
     ...
     str = [str, ' PARAMETER HW_VER = 1.00.a',                               '\n'];
     str = [str, ' PARAMETER C_BASEADDR = 0x00050000',                       '\n'];
     str = [str, ' PARAMETER C_HIGHADDR = 0x0005FFFF',                       '\n'];
     str = [str, ' BUS_INTERFACE SOPB = opb0',                               '\n'];
     str = [str, ' BUS_INTERFACE DDR2_CTRL = ddr2_ctrl',                     '\n'];
