...
function forty_gbe_mask_draw_rxsnap(cursys, qsfp_num, pipe_no_pipe, valid_source)
...
if strcmp(snaplen, '0 - no snap') == 0
    ...
    for ctr = 1 : num_delays
        ...
        reuse_block(cursys, delay_name,  ...
            'xbsIndex_r4/Delay', 'reg_retiming', 'on', 'latency', '1', ...
            'Position', [2350 ypos 2370 ypos+20]);
        ypos = ypos + 20;
    ...
    if rx_snap_case == 3
        reuse_block(cursys, 'rxs3_del0',  ...
            'xbsIndex_r4/Delay', 'reg_retiming', 'on', 'latency', '1', ...
            'Position', [2350        2190        2370        2210]);
        reuse_block(cursys, 'rxs3_del1',  ...
            'xbsIndex_r4/Delay', 'reg_retiming', 'on', 'latency', '1', ...
            'Position', [2350        2235        2370        2255]);
    ...
    reuse_block(cursys, 'rxsnap_and', 'xbsIndex_r4/Logical', ...
        ...
        'inputs', '2', 'latency', '1', 'Position', [2300 1500 2350 1550]);
    add_line_s(cursys, strcat('rx_data',pipe_no_pipe, '/1'), ...
            'rxs_exp_del/1');
    add_line_s(cursys, 'rxs_exp_del/1', 'rxs_exp/1');
    add_line_s(cursys, strcat('led_up',pipe_no_pipe, '/1'),           'rxs_1_del/1');
    add_line_s(cursys, strcat('led_rx',pipe_no_pipe, '/1'),           'rxs_2_del/1');
    add_line_s(cursys, [valid_source, '/1'],                                    'rxs_3_del/1');
    add_line_s(cursys, [valid_source, '/1'],                                    'rxsnap_and/1');
    add_line_s(cursys, strcat('rx_end_of_frame',pipe_no_pipe, '/1'),  'rxsnap_and/2');
    if (rx_snap_case == 2) || (rx_snap_case == 1)
        if rx_snap_case == 2
            add_line_s(cursys, strcat('rx_source_ip',pipe_no_pipe, '/1'),     'rxs_4_del/1');
        else
            add_line_s(cursys, strcat('rx_dest_ip',pipe_no_pipe, '/1'),     'rxs_4_del/1');
        end
        add_line_s(cursys, strcat('rx_end_of_frame',pipe_no_pipe, '/1'),  'rxs_5_del/1');
        add_line_s(cursys, strcat('rx_bad_frame',pipe_no_pipe, '/1'),     'rxs_6_del/1');
        add_line_s(cursys, strcat('rx_overrun',pipe_no_pipe, '/1'),       'rxs_7_del/1');
        add_line_s(cursys, [valid_source, '/1'],                                    'rxs_8_del/1');
        add_line_s(cursys, 'rxsnap_and/1', 'rxs0/9');
    else
        add_line_s(cursys, strcat('rx_end_of_frame',pipe_no_pipe, '/1'),  'rxs_4_del/1');
        add_line_s(cursys, strcat('rx_bad_frame',pipe_no_pipe, '/1'),     'rxs_5_del/1');
        add_line_s(cursys, strcat('rx_overrun',pipe_no_pipe, '/1'),       'rxs_6_del/1');
    ...
    if rx_snap_case == 3
        add_line_s(cursys, strcat('rx_source_ip',pipe_no_pipe, '/1'), 'rxs3_del0/1');
        add_line_s(cursys, strcat('rx_dest_ip',pipe_no_pipe, '/1'), 'rxs3_del1/1');
