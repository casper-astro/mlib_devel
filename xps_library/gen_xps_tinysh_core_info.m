...
%   netlist_path    = mssge_paths.netlist_path;
    ...
    fprintf(nfo_fid,'typedef enum blk_types {xps_block,xps_bram,xps_corr_adc,xps_corr_dac,xps_corr_mxfe,xps_corr_rf,xps_dram,xps_ethlite,xps_framebuffer,xps_fifo,xps_gpio,xps_interchip,xps_lwip,xps_opb2opb,xps_probe,xps_sram,xps_sw_reg,xps_tengbe,xps_vsi,xps_xaui,xps_xsg,');
