...
function draw_to()
    ...
    for pindex = 1 : numios
        ...
        reuse_block(blk, assert_name, 'xbsIndex_r4/Assert', ...
            ...
            'gui_display_data_type', gddtype, 'arith_type', type_to_string(current_types(pindex)), ...
            'bin_pt', num2str(current_bins(pindex)), ...
...
function draw_from()
    ...
    for pindex = 1 : numios
        ...
        reuse_block(blk, gain_name, 'simulink/Commonly Used Blocks/Gain', 'Gain', num2str(pow2(total_width)), 'OutDataTypeStr', 'fixdt(''ufix32_En0'')',...
