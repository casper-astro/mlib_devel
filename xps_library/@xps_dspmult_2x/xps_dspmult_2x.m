...
function b = xps_dspmult_2x(blk_obj)

if ~isa(blk_obj,'xps_block')
    error('XPS_DSPMULT_2X class requires a xps_block class object');
end

if ~strcmp(get(blk_obj,'type'),'xps_dspmult_2x')
...
b = class(s,'xps_dspmult_2x',blk_obj);

% ip name and version
b = set(b, 'ip_name', 'dspmult_2x');
switch s.hw_sys
    case 'ROACH'
