...
gateways_blk = find_system(sys, 'FollowLinks', 'on', 'LookUnderMasks', 'all', 'masktype', gwi_name);
...
target_tags = {'xps_block'...
    ...
    'xps_sram' 'xps_sw_reg' 'xps_tengbe' 'xps_vsi' 'xps_xaui' 'xps_xsg'};
for n = 1 : length(xps_blks),
