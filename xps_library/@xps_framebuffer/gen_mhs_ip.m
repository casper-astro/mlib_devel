...
str = [str, ' PARAMETER C_WIDE_DATA  = 0\n'];
str = [str, ' PARAMETER C_HALF_BURST = 1\n'];
...
str = [str, ' PARAMETER BANK_MANAGEMENT = 0\n'];
...
str = [str, 'BEGIN framebuffer\n'];
str = [str, ' PARAMETER INSTANCE        = ',inst_name,'_framebuffer\n'];
str = [str, ' PARAMETER HW_VER          = 2.00.a\n'];
str = [str, ' PARAMETER C_WIDE_DATA     = 0\n'];
str = [str, ' PARAMETER C_HALF_BURST    = 1\n'];
str = [str, ' BUS_INTERFACE MEM_CMD     = ',inst_name,'_fb_MEM_CMD\n'];
str = [str, ' PORT Mem_Clk              = ',get(xsg_obj, 'clk_src'),'\n'];
str = [str, ' PORT pixel_clk            = sys_clk\n'];
str = [str, ' PORT pixel_clk90          = sys_clk90\n'];
str = [str, ' PORT dvi_data             = dvi_data\n'];
str = [str, ' PORT dvi_idck_p           = dvi_idck_p\n'];
str = [str, ' PORT dvi_idck_m           = dvi_idck_m\n'];
str = [str, ' PORT dvi_vsync            = dvi_vsync\n'];
str = [str, ' PORT dvi_hsync            = dvi_hsync\n'];
str = [str, ' PORT dvi_de               = dvi_de\n'];
str = [str, ' PORT fb_blank             = fb_blank\n'];
str = [str, ' PORT fb_addr              = fb_addr\n'];
str = [str, 'END\n'];
str = [str, 'PORT dvi_data             = dvi_data,   DIR = O, VEC = [11:0]\n'];
str = [str, 'PORT dvi_idck_p           = dvi_idck_p, DIR = O\n'];
str = [str, 'PORT dvi_idck_m           = dvi_idck_m, DIR = O\n'];
str = [str, 'PORT dvi_vsync            = dvi_vsync,  DIR = O\n'];
str = [str, 'PORT dvi_hsync            = dvi_hsync,  DIR = O\n'];
str = [str, 'PORT dvi_de               = dvi_de,     DIR = O\n'];
str = [str, 'BEGIN framebuffer_writer\n'];
str = [str, ' PARAMETER INSTANCE        = ',inst_name,'_framebuffer_writer\n'];
str = [str, ' PARAMETER HW_VER          = 2.00.a\n'];
str = [str, ' PARAMETER C_WIDE_DATA     = 0\n'];
str = [str, ' PARAMETER C_HALF_BURST    = 1\n'];
str = [str, ' BUS_INTERFACE MEM_CMD     = ',inst_name,'_fbw_MEM_CMD\n'];
str = [str, ' PORT Mem_Clk              = ',get(xsg_obj, 'clk_src'),'\n'];
str = [str, ' PORT fb_blank             = fb_blank\n'];
str = [str, ' PORT fb_addr              = fb_addr\n'];
if ~isempty(ports)
...
str = [str, 'BEGIN multiport_ddr2\n'];
str = [str, ' PARAMETER INSTANCE        = multiport_ddr2_dimm',dimm,'\n'];
str = [str, ' PARAMETER HW_VER          = 2.00.a\n'];
str = [str, ' PARAMETER C_WIDE_DATA     = 0\n'];
str = [str, ' PARAMETER C_HALF_BURST    = 1\n'];
str = [str, ' PARAMETER C_BURST_WINDOW  = 160\n'];
str = [str, ' PARAMETER C_BWIND_WIDTH   = 8\n'];
str = [str, ' BUS_INTERFACE MEM_CMD_IN0 = ',inst_name,'_fbw_MEM_CMD\n'];
str = [str, ' BUS_INTERFACE MEM_CMD_IN1 = ',inst_name,'_fb_MEM_CMD\n'];
str = [str, ' BUS_INTERFACE MEM_CMD_OUT = ', inst_name, '_MEM_CMD\n'];
str = [str, ' PORT Clk                  = ',get(xsg_obj, 'clk_src'),'\n'];
str = [str, ' PORT Rst                  = net_gnd\n'];
str = [str, 'END\n'];
