    ...
    case 'ROACH2'
        ...
        switch adc_str
            case 'adc0'
                ...
                str = [str, 'OFFSET=IN ',sprintf('%1.3f',(2000.0/adc_clk_rate)-0.4),' ns BEFORE "adc0_adc_clk_p" RISING;\n'];
                str = [str, 'OFFSET=IN ',sprintf('%1.3f',(2000.0/adc_clk_rate)-0.4),' ns BEFORE "adc0_adc_clk_p" FALLING;\n'];             
                str = [str,'\n'];
            % end case 'adc0'
            ...
            case 'adc1'
                ...
                str = [str, 'INST "', simulink_name, '/', simulink_name, ...
                     '/adc5g_inst/data_buf[3].D0?_1"     AREA_GROUP     = ZDOK_1_r3 ;\n'];
                str = [str, 'AREA_GROUP "ZDOK_1_r3"     RANGE    = ', ...
                     'SLICE_X86Y207:SLICE_X87Y208 ;\n'];

                str = [str, 'INST "', simulink_name, '/', simulink_name, ...
                     '/adc5g_inst/data_buf[5].D0?_1"     AREA_GROUP     = ZDOK_1_r5 ;\n'];
                str = [str, 'AREA_GROUP "ZDOK_1_r5"     RANGE    = ', ...
                     'SLICE_X86Y203:SLICE_X87Y204 ;\n'];
