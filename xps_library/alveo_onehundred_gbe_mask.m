...
% tx counter
starty = 850;
draw_rxcounter(cursys, 400, starty, 'txctr', 'tx_eof', 'tx_valid');

% tx error counter
starty = starty + 50;
draw_errorcounter(cursys, 400, starty, 'txerrctr', get_param(cursys, 'txerrctr_len'), 'tx_eof', 'tx_valid');
...
% rx counter
starty = 130;
% draw_rxcounter(cursys, 1400, starty, 'rxctr', clear_name([cursys, '_rx_eof']), valid_source)
draw_rxcounter(cursys, 1400, starty, 'rxctr', clear_name([pipe_no_pipe, '_rx_eof']), valid_source)

% rx error counter
starty = starty + 50;
% draw_errorcounter(cursys, 1400, starty, 'rxerrctr', get_param(cursys, 'rxerrctr_len'), clear_name([cursys, '_rx_eof']), valid_source);
draw_errorcounter(cursys, 1400, starty, 'rxerrctr', get_param(cursys, 'rxerrctr_len'), clear_name([pipe_no_pipe, '_rx_eof']), valid_source);
...
% rx eof counter
starty = starty + 50;
% draw_counter(cursys, 1400, starty, 'rxeofctr', clear_name([cursys, '_rx_eof']));
draw_counter(cursys, 1400, starty, 'rxeofctr', clear_name([pipe_no_pipe, '_rx_eof']));
