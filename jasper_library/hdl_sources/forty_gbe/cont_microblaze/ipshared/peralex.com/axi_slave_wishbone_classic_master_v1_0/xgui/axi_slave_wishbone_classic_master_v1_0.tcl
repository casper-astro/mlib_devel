...
proc init_gui { IPINST } {
	...
	set C_S_AXI_BUSER_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S_AXI_BUSER_WIDTH]
	set C_S_AXI_RUSER_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S_AXI_RUSER_WIDTH]
	set C_S_AXI_WUSER_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S_AXI_WUSER_WIDTH]
	set C_S_AXI_ARUSER_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S_AXI_ARUSER_WIDTH]
	set C_S_AXI_AWUSER_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S_AXI_AWUSER_WIDTH]
