...
wire [5:0] irtry_start_retry_cnt;
wire [5:0] irtry_clear_error_cnt;
...
rx_link #(
    ...
    .irtry_clear_error_cnt_o(irtry_clear_error_cnt),
    .irtry_start_retry_cnt_o(irtry_start_retry_cnt),
...
generate 
    ...
    .irtry_clear_error_cnt(irtry_clear_error_cnt),
    .irtry_start_retry_cnt(irtry_start_retry_cnt),
