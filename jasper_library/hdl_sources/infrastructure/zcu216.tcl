...
################################################################
# This is a generated script based on design: zcu216
#
...
if { $list_projs eq "" } {
   create_project project_1 myproj -part xczu49dr-ffvf1760-2-e-es1
}


# CHANGE DESIGN NAME HERE
variable design_name
set design_name zcu216
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_DOMAIN {zcu216_clk_wiz_0_0_clk_out1} \
  ...
  set rfdc_m00_axis [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 rfdc_m00_axis ]
  set_property -dict [ list \
  ...
  # Create ports
  set lmk_ref [ create_bd_port -dir I -type clk -freq_hz 250000000 lmk_ref ]
  set locked_led [ create_bd_port -dir O locked_led ]
  set rfdc_clk_adc0 [ create_bd_port -dir O -type clk rfdc_clk_adc0 ]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_0_m00_axis [get_bd_intf_ports rfdc_m00_axis] [get_bd_intf_pins usp_rf_data_converter_0/m00_axis]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/m0_axis_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports locked_led] [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked] [get_bd_pins rst_ps8_0_99M/dcm_locked]
  connect_bd_net -net lmk_ref_1 [get_bd_ports lmk_ref] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc0 [get_bd_ports rfdc_clk_adc0] [get_bd_pins usp_rf_data_converter_0/clk_adc0]
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs M_AXI/Reg] -force
