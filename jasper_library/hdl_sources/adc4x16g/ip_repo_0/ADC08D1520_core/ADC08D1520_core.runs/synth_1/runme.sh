...
HD_PWD='C:/XilinxProjects/ip_repo/ADC08D1520_core/ADC08D1520_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_core_block.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ADC_core_block.tcl
