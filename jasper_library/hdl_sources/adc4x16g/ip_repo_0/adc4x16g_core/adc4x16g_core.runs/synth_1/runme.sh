...
HD_PWD='C:/XilinxProjects/ip_repo/adc4x16g_core/adc4x16g_core.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gty_wrapper_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gty_wrapper_0.tcl
