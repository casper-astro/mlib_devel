...
#
# Generated by export_simulation on Mon Mar 30 22:07:18 -0700 2020
#
################################################################################
...
'-reset_run' switch to the './gtwizard_ultrascale_1.sh' script.

./gtwizard_ultrascale_1.sh -reset_run
...
./gtwizard_ultrascale_1.sh -noclean_files

For more information on the script, please type './gtwizard_ultrascale_1.sh -help'.
