...
class forty_gbe(YellowBlock):
    ...
    def modify_top(self,top):
        ...
        inst.add_wb_interface(self.unique_name, mode='rw', nbytes=0x16000) # as in matlab code
        ...
        inst.add_port('MEZ3_REFCLK_0_P',    'MEZ3_REFCLK_P',                    parent_port=True, dir='in')
        inst.add_port('MEZ3_REFCLK_0_N',    'MEZ3_REFCLK_N',                    parent_port=True, dir='in')
