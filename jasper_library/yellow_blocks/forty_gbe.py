...
class forty_gbe(YellowBlock):
    ...
    def instantiate_fgbe(self, top, num=None):
        ...
        inst.add_port('MEZ_PHY11_LANE_RX_P', 'MEZ_PHY11_LANE_RX_P', parent_port=True, dir='in', width=4)
        inst.add_port('MEZ_PHY11_LANE_RX_N', 'MEZ_PHY11_LANE_RX_N', parent_port=True, dir='in', width=4)
        inst.add_port('MEZ_PHY11_LANE_TX_P', 'MEZ_PHY11_LANE_TX_P', parent_port=True, dir='out', width=4)
        inst.add_port('MEZ_PHY11_LANE_TX_N', 'MEZ_PHY11_LANE_TX_N', parent_port=True, dir='out', width=4)
    ...
    def gen_constraints(self):
        ...
        cons.append(PortConstraint('MEZ_PHY11_LANE_TX_N', 'MEZ_PHY11_LANE_TX_N', port_index=range(4),  iogroup_index=range(4)))
        cons.append(PortConstraint('MEZ_PHY11_LANE_TX_P', 'MEZ_PHY11_LANE_TX_P', port_index=range(4),  iogroup_index=range(4)))
        cons.append(PortConstraint('MEZ_PHY11_LANE_RX_N', 'MEZ_PHY11_LANE_RX_N', port_index=range(4),  iogroup_index=range(4)))
        cons.append(PortConstraint('MEZ_PHY11_LANE_RX_P', 'MEZ_PHY11_LANE_RX_N', port_index=range(4),  iogroup_index=range(4)))
        cons.append(PortConstraint('FLASH_DQ',            'FLASH_DQ',            port_index=range(16), iogroup_index=range(16)))
        cons.append(PortConstraint('FPGA_GPIO',           'FPGA_GPIO',           port_index=range(15), iogroup_index=range(15)))
        ...
        cons.append(PortConstraint('GND',                 'GND',                 port_index=range(15), iogroup_index=range(15)))
        ...
        cons.append(PortConstraint('MEZ_REFCLK_0_P','MEZ_REFCLK_0_P'))
        cons.append(PortConstraint('MEZZANINE_3_ONE_WIRE_STRONG_PULLUP_EN_N','MEZZANINE_3_ONE_WIRE_STRONG_PULLUP_EN_N'))
        cons.append(PortConstraint('MEZ_REFCLK_0_N','MEZ_REFCLK_0_N'))
        ...
        cons.append(PortConstraint('MEZ_PHY11_LANE_TX_N','MEZ_PHY11_LANE_TX_N'))
        ...
        cons.append(PortConstraint('MEZ_PHY11_LANE_RX_P','MEZ_PHY11_LANE_RX_P'))
        cons.append(PortConstraint('MEZ_PHY11_LANE_RX_N','MEZ_PHY11_LANE_RX_N'))
        ...
        cons.append(PortConstraint('MEZ_PHY11_LANE_TX_P','MEZ_PHY11_LANE_TX_P'))
        ...
        cons.append(RawConstraint('set_property is_locked true [get_files ./myproj/myproj.srcs/sources_1/bd/cont_microblaze/cont_microblaze.bd]'))
        cons.append(RawConstraint('set_property is_locked true [get_files ./myproj/myproj.srcs/sources_1/ip/gmii_to_sgmii/gmii_to_sgmii.xci]'))
        cons.append(RawConstraint('set_property SCOPED_TO_REF IEEE802_3_XL_PCS [get_files ./myproj/myproj.srcs/constrs_1/imports/new/IEEE802_3_XL_PCS.xdc]'))
        cons.append(RawConstraint('set_property processing_order LATE [get_files ./myproj/myproj.srcs/constrs_1/imports/new/IEEE802_3_XL_PCS.xdc]'))
        cons.append(RawConstraint('set_property SCOPED_TO_REF DATA_FREQUENCY_DIVIDER [get_files ./myproj/myproj.srcs/constrs_1/imports/new/DATA_FREQUENCY_DIVIDER.xdc]'))
        cons.append(RawConstraint('set_property processing_order LATE [get_files ./myproj/myproj.srcs/constrs_1/imports/new/DATA_FREQUENCY_DIVIDER.xdc]'))
        cons.append(RawConstraint('set_property SCOPED_TO_REF DATA_FREQUENCY_MULTIPLIER [get_files ./myproj/myproj.srcs/constrs_1/imports/new/DATA_FREQUENCY_MULTIPLIER.xdc]'))
        cons.append(RawConstraint('set_property processing_order LATE [get_files ./myproj/myproj.srcs/constrs_1/imports/new/DATA_FREQUENCY_MULTIPLIER.xdc]'))
        cons.append(RawConstraint('set_property SCOPED_TO_REF IEEE802_3_XL_PHY [get_files ./myproj/myproj.srcs/constrs_1/imports/new/IEEE802_3_XL_PHY.xdc]'))
        cons.append(RawConstraint('set_property processing_order LATE [get_files ./myproj/myproj.srcs/constrs_1/imports/new/IEEE802_3_XL_PHY.xdc]'))
        cons.append(RawConstraint('set_property SCOPED_TO_REF cont_microblaze [get_files ./myproj/myproj.srcs/sources_1/imports/cont_microblaze/EMB123701U1R1.elf]'))
        cons.append(RawConstraint('set_property SCOPED_TO_REF cont_microblaze [get_files ./myproj/myproj.srcs/sources_1/bd/cont_microblaze/cont_microblaze.bmm]'))
        cons.append(RawConstraint('set_property SCOPED_TO_CELLS microblaze_0 [get_files ./myproj/myproj.srcs/sources_1/imports/cont_microblaze/EMB123701U1R1.elf]'))
