...
class forty_gbe(YellowBlock):
    ...
    def instantiate_fgbe(self, top, num=None):
        ...
        for i in range(self.port):
            cur_port = i+1
            inst.add_port('forty_gbe_rst',             self.fullname+'_rst'+cur_port,             width=1,   dir='in')
            inst.add_port('forty_gbe_tx_valid',        self.fullname+'_tx_valid'+cur_port,        width=4,   dir='in')
            inst.add_port('forty_gbe_tx_end_of_frame', self.fullname+'_tx_end_of_frame'+cur_port, width=1,   dir='in')
            inst.add_port('forty_gbe_tx_data',         self.fullname+'_tx_data'+cur_port,         width=256, dir='in')
            inst.add_port('forty_gbe_tx_dest_ip',      self.fullname+'_tx_dest_ip'+cur_port,      width=32,  dir='in')
            inst.add_port('forty_gbe_tx_dest_port',    self.fullname+'_tx_dest_port'+cur_port,    width=16,  dir='in')
            inst.add_port('forty_gbe_tx_overflow',     self.fullname+'_tx_overflow'+cur_port,     width=1,   dir='out')
            inst.add_port('forty_gbe_tx_afull',        self.fullname+'_tx_afull'+cur_port,        width=1,   dir='out')
            inst.add_port('forty_gbe_rx_valid',        self.fullname+'_rx_valid'+cur_port,        width=4,   dir='out')
            inst.add_port('forty_gbe_rx_end_of_frame', self.fullname+'_rx_end_of_frame'+cur_port, width=1,   dir='out')
            inst.add_port('forty_gbe_rx_data',         self.fullname+'_rx_data'+cur_port,         width=256, dir='out')
            inst.add_port('forty_gbe_rx_source_ip',    self.fullname+'_rx_source_ip'+cur_port,    width=32,  dir='out')
            inst.add_port('forty_gbe_rx_dest_ip',      self.fullname+'_rx_dest_ip'+cur_port,      width=32,  dir='out')
            inst.add_port('forty_gbe_rx_source_port',  self.fullname+'_rx_source_port'+cur_port,  width=16,  dir='out')
            inst.add_port('forty_gbe_rx_dest_port',    self.fullname+'_rx_dest_port'+cur_port,    width=16,  dir='out')
            inst.add_port('forty_gbe_rx_bad_frame',    self.fullname+'_rx_bad_frame'+cur_port,    width=1,   dir='out')
            inst.add_port('forty_gbe_rx_overrun',      self.fullname+'_rx_overrun'+cur_port,      width=1,   dir='out')
            inst.add_port('forty_gbe_rx_overrun_ack',  self.fullname+'_rx_overrun_ack'+cur_port,  width=1,   dir='in')
            inst.add_port('forty_gbe_rx_ack',          self.fullname+'_rx_ack'+cur_port,          width=1,   dir='in')

            inst.add_port('forty_gbe_led_rx',          self.fullname+'_led_rx'+cur_port,          width=1,  dir='out')
            inst.add_port('forty_gbe_led_tx',          self.fullname+'_led_tx'+cur_port,          width=1,  dir='out')
            inst.add_port('forty_gbe_led_up',          self.fullname+'_led_up'+cur_port,          width=1,  dir='out')
