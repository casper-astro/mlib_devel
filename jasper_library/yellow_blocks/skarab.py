...
class skarab(YellowBlock):
    def initialize(self):
        ...
        self.add_source("skarab_infr/cross_clock_fifo_67x16/*.xci")
        self.add_source("skarab_infr/cross_clock_fifo_36x16/*.xci")
        self.add_source("skarab_infr/cross_clock_fifo_259x16/*.xci")
        self.add_source("skarab_infr/cross_clock_fifo_67x16/*.xci")
    ...
    def modify_top(self,top):
        ...
        #inst.add_port('gbe_link_up'       , 'gbe_link_up'           , parent_sig=True, dir='in')
        ...
        #inst.add_port('host_reset_gmii_synced', 'host_reset_gmii_synced', parent_sig=True, dir='out')
        #inst.add_port('host_reset_o'      , 'host_reset_o'          , parent_sig=True, dir='out')
        #inst.add_port('user_mmcm_locked_o', 'user_mmcm_locked_o'    , parent_sig=True, dir='out')
