...
class skarab(YellowBlock):
    ...
    def gen_constraints(self):
        ...
        cons.append(ClockGroupConstraint('-of_objects [get_pins %s/SYS_CLK_MMCM_inst/CLKOUT0]'  % self.fullname, 'MEZ3_REFCLK_P', 'asynchronous'))
        ...
        cons.append(ClockGroupConstraint('MEZ3_REFCLK_P', '-of_objects [get_pins %s/gmii_to_sgmii_0/U0/core_clocking_i/mmcm_adv_inst/CLKOUT0]' % self.fullname, 'asynchronous'))
        ...
        cons.append(ClockGroupConstraint('VIRTUAL_clkout0', 'MEZ3_REFCLK_P', 'asynchronous'))
        cons.append(ClockGroupConstraint('MEZ3_REFCLK_P', 'FPGA_EMCCLK2', 'asynchronous'))
        cons.append(ClockGroupConstraint('FPGA_EMCCLK2', 'MEZ3_REFCLK_P', 'asynchronous'))
