...
class tengbaser_xilinx_usplus(ten_gbe):
    ...
    def instantiate_pcs(self, top, num):
        ...
        inst.add_port('gt_txp_in_0', 'mgt_tx_p%d'%self.port, parent_port=True, dir='out')
        inst.add_port('gt_txn_in_0', 'mgt_tx_n%d'%self.port, parent_port=True, dir='out')
        ...
        inst.add_port('ctrl_rx_data_pattern_select_0', "1'b0")
        inst.add_port('ctrl_rx_prbs31_test_pattern_enable_0', "1'b0")
        inst.add_port('ctrl_rx_test_pattern_0', "1'b0")
        inst.add_port('ctrl_rx_test_pattern_enable_0', "1'b0")
        inst.add_port('ctr_tx_test_pattern_0', "1'b0")
        inst.add_port('ctr_tx_test_pattern_enable_0', "1'b0")
        inst.add_port('ctr_tx_test_pattern_select_0', "1'b0")
        inst.add_port('ctr_tx_test_pattern_seed_a_0', "58'b0")
        inst.add_port('ctr_tx_test_pattern_seed_b_0', "58'b0")
        inst.add_port('ctr_tx_prbs31_test_pattern_enable_0', "1'b0")
        inst.add_port('gt_loopback_in_0', "3'b0")

        inst.add_port('tx_core_clk_0', 'core_clk_156_%d'%num)
        inst.add_port('txoutclksel_in_0', "3'b000")
        inst.add_port('rxoutclksel_in_0', "3'b000")
