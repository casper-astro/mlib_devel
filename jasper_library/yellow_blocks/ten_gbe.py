...
class tengbaser_xilinx_ultrascale(ten_gbe):
    ...
    def instantiate_infra(self, top, num):
        ...
        infra.add_port('gt_refclk_out','core_clk_156_%d'%num)
        infra.add_port('qpll0reset','gtwiz_reset_qpll0reset_out')
        infra.add_port('qpll0lock','gtwiz_reset_qpll0lock_in')
        infra.add_port('qpll0outclk','qpll0clk_in')
        infra.add_port('qpll0outrefclk','qpll0refclk_in')
        infra.add_port('qpll1reset','gtwiz_reset_qpll1reset_out')
        infra.add_port('qpll1lock','gtwiz_reset_qpll1lock_in')
        infra.add_port('qpll1outclk','qpll1clk_in')
        infra.add_port('qpll1outrefclk','qpll1refclk_in')
        infra.add_port('gt_txusrclk2_0','tx_mii_clk_0')
        infra.add_port('gt_rxusrclk2_0','rx_clk_out_0')
        ...
        infra.add_port('usr_tx_reset_0','')
        infra.add_port('usr_rx_reset_0','')
        infra.add_port('gtwiz_reset_all_0','gt_reset_all_0')
        infra.add_port('gtwiz_reset_tx_datapath_out_0','gtwiz_reset_tx_datapath_out_0')
        infra.add_port('gtwiz_reset_rx_datapath_out_0','gtwiz_reset_rx_datapath_out_0')
        infra.add_port('sys_reset','axil_rst')
        infra.add_port('dclk','dclk%d'%num)
    ...
    def instantiate_phy(self, top, num):
        ...
        phy.add_port('tx_mii_clk_0','tx_mii_clk_0')
        phy.add_port('rx_core_clk_0','rx_clk_out_0')
        phy.add_port('rx_clk_out_0','rx_clk_out_0')
        phy.add_port('gt_loopback_in_0',"3'b000")
        #RX_0 Signals
        phy.add_port('rx_reset_0','rx_core_reset_out')
        ...
        #TX_0 Signals
        phy.add_port('tx_reset_0','tx_core_reset_out')
        ...
        #reset signals
        phy.add_port('rx_serdes_reset_0','rx_serdes_reset_0')
        phy.add_port('gt_reset_all_in_0','gt_reset_all_0')
        phy.add_port('gt_tx_reset_in_0','gtwiz_reset_tx_datapath_out_0')
        phy.add_port('gt_rx_reset_in_0','gtwiz_reset_rx_datapath_out_0')
        phy.add_port('gt_reset_tx_done_out_0','gt_reset_tx_done_out_0')
        phy.add_port('gt_reset_rx_done_out_0','gt_reset_rx_done_out_0')
        #clk signals
        phy.add_port('qpll0clk_in','qpll0clk_in')
        phy.add_port('qpll0refclk_in','qpll0refclk_in')
        phy.add_port('qpll1clk_in','qpll1clk_in')
        phy.add_port('qpll1refclk_in','qpll1refclk_in')
        phy.add_port('gtwiz_reset_qpll0lock_in','gtwiz_reset_qpll0lock_in')
        phy.add_port('gtwiz_reset_qpll1lock_in','gtwiz_reset_qpll1lock_in')
        phy.add_port('gtwiz_reset_qpll0reset_out','gtwiz_reset_qpll0reset_out')
        phy.add_port('gtwiz_reset_qpll1reset_out','gtwiz_reset_qpll1reset_out')
        #sys reset
        phy.add_port('sys_reset','axil_rst')
        #dclk
        phy.add_port('dclk','dclk%d'%num)
    ...
    def gen_constraints(self):
        ...
        cons.append(ClockConstraint('ref_clk_p%d'%num, name='ethclk%d'%num, freq=156.25))
        cons.append(RawConstraint('set_clock_groups -name asyncclocks_eth0 -asynchronous -group [get_clocks -include_generated_clocks clk_100_p] -group [get_clocks -include_generated_clocks ethclk0]'))
        ...
        cons.append(RawConstraint('set_clock_groups -name asyncclocks_eth2 -asynchronous -group [get_clocks -of_objects [get_pins zcu111_inst/zynq_ultra_ps_e_0/U0/PS8_i/PLCLK[0]]] -group [get_clocks -include_generated_clocks clk_100_p]'))
        return cons
