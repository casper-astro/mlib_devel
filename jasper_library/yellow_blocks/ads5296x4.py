...
class ads5296x4(YellowBlock):
    ...
    def gen_constraints(self):
        ...
        for b in range(self.board_count):
            cons.append(InputDelayConstraint(clkname=clocks[b].name, consttype='min', constdelay_ns=1.0, portname="%s_%d_din_p[*]" % (self.port_prefix, b)))
            cons.append(InputDelayConstraint(clkname=clocks[b].name, consttype='max', constdelay_ns=1.0, portname="%s_%d_din_p[*]" % (self.port_prefix, b)))
