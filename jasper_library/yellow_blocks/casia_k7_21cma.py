...
class casia_k7_21cma(YellowBlock):
    def initialize(self):
    ...
    def modify_top(self,top):
        inst = top.get_instance('casia_k7_21cma_infrastructure', 'casia_k7_21cma_infrastructure_inst')
        ...
        inst.add_port('sys_clk_in', 'sys_clk_in', parent_port=True, dir='in')
    ...
    def gen_constraints(self):
        cons =[
            ...
            PortConstraint('sys_clk_in', 'sys_clk_in'),
            ClockConstraint('sys_clk_in', period=20),
