...
#        inst.add_port('DDR_VRP', 'DDR_VRP', dir='inout', width=1, parent_port=True)
#        inst.add_port('DDR_VRN', 'DDR_VRN', dir='inout', width=1, parent_port=True)
#        inst.add_port('DDR_WEB', 'DDR_WEB', dir='out', width=1, parent_port=True)
        inst.add_port('DDR_RAS_n', 'DDR_RAS_n', dir='out', width=1, parent_port=True)
        inst.add_port('DDR_ODT', 'DDR_ODT', dir='out', width=1, parent_port=True)
#        inst.add_port('DDR_DRSTB', 'DDR_DRSTB', dir='inout', width=1, parent_port=True)
#        inst.add_port('DDR_DQS', 'DDR_DQS', dir='inout', width=4, parent_port=True)
        ...
        inst.add_port('DDR_CS_n', 'DDR_CS_n', dir='out', width=1, parent_port=True)
        inst.add_port('DDR_CKE', 'DDR_CKE', dir='out', width=1, parent_port=True)
#        inst.add_port('DDR_Clk', 'DDR_Clk', dir='in', width=1, parent_port=True)
#        inst.add_port('DDR_Clk_n', 'DDR_Clk_n', dir='in', width=1, parent_port=True)
        inst.add_port('DDR_CAS_n', 'DDR_CAS_n', dir='out', width=1, parent_port=True)
#        inst.add_port('DDR_BankAddr', 'DDR_BankAddr', dir='out', width=3, parent_port=True)
...
#        cons.append(PortConstraint('DDR_VRP', 'DDR_VRP'))
#        cons.append(PortConstraint('DDR_VRN', 'DDR_VRN'))
#        cons.append(PortConstraint('DDR_WEB', 'DDR_WEB'))
        cons.append(PortConstraint('DDR_RAS_n', 'DDR_RAS_n'))
        cons.append(PortConstraint('DDR_ODT', 'DDR_ODT'))
#        cons.append(PortConstraint('DDR_DRSTB', 'DDR_DRSTB'))
#        cons.append(PortConstraint('DDR_DQS', 'DDR_DQS', port_index=list(range(4)), iogroup_index=list(range(4))))
...
#        cons.append(PortConstraint('DDR_Clk', 'DDR_Clk'))
#        cons.append(PortConstraint('DDR_Clk_n', 'DDR_Clk_n'))
        cons.append(PortConstraint('DDR_CAS_n', 'DDR_CAS_n'))
#        cons.append(PortConstraint('DDR_BankAddr', 'DDR_BankAddr', port_index=list(range(3)), iogroup_index=list(range(3))))
