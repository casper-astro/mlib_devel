    ...
    def modify_top(self,top):
        if self.blk['io_dir'] == 'To Processor':
            if self.platform.mmbus_architecture == 'AXI4-Lite':
                ...
                inst.add_port('IP_BUS',       signal='sw_reg_%s_user_data_in'%self.fullname, width=32, parent_sig=True)
                inst.add_port('OP_BUS',       signal='sw_reg_%s_in'%self.unique_name, width=32, parent_sig=True)
            else:
            ...
            if self.platform.mmbus_architecture == 'AXI4-Lite':
                ...
                inst.add_port('IP_BUS',       signal='sw_reg_%s_out'%self.unique_name, width=32, parent_sig=True)
