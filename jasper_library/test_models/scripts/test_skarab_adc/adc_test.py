...
class skarab_adc_rx:
	...
	def PerformAdcPllSync(self, skarab):
		...
		skarab.transport.write_i2c(i2c_interface, sd.STM_I2C_DEVICE_ADDRESS, sd.ADC_FIRMWARE_VERSION_MAJOR_REG)
		major_version = skarab.transport.read_i2c(i2c_interface, sd.STM_I2C_DEVICE_ADDRESS, 1)
		skarab.transport.write_i2c(i2c_interface, sd.STM_I2C_DEVICE_ADDRESS, sd.ADC_FIRMWARE_VERSION_MINOR_REG)
