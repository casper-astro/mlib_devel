...
check_mask_type(blk, 'twiddle_general_3mult_mux');
...
reuse_block(blk, 'Delay', 'xbsIndex_r4/Delay', ...
    'latency',tostring(mult_latency + 2*add_latency + bram_latency + conv_latency), ...
...
reuse_block(blk, 'coeff_gen', 'ox_lib/Twiddle/coeff_gen/coeff_gen', ...
