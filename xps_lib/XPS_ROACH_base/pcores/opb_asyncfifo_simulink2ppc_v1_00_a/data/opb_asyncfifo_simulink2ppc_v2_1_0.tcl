...
proc generate_fifo {mhsinst} {
	...
	puts $outputFile "CSET write_data_count_width         = 2"
	puts $outputFile "CSET data_count_width               = 2"
	puts $outputFile "CSET output_depth                   = [expr $length*$width/32]"
	...
	puts $outputFile "CSET read_data_count                = true"
	puts $outputFile "CSET data_count                     = false"
	puts $outputFile "CSET programmable_full_type         = Single_Programmable_Full_Threshold_Input_Port"
	puts $outputFile "CSET read_data_count_width          = [min [expr round(log10($length*$width/32)/log10(2))] [expr round(log10($length)/log10(2))]]"
	...
	puts $outputFile "CSET input_data_width               = $width"
