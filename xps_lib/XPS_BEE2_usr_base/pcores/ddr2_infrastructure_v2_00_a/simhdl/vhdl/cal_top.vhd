...
attribute syn_preserve of cal_clkd2 : label is true;
attribute syn_preserve of cal_phClkd2 : label is true;
attribute syn_keep of cal_clkd2 : label is true;
attribute syn_keep of cal_phClkd2 : label is true;
attribute syn_preserve of phClkDiv2 : signal is true;
attribute syn_preserve of ClkDiv2 : signal is true;
attribute syn_keep of phClkDiv2 : signal is true;
attribute syn_keep of ClkDiv2 : signal is true;
attribute syn_noprune of cal_suClkd2 : label is true;
attribute syn_noprune of cal_suPhClkd2 : label is true;
attribute syn_preserve of cal_suClkd2 : label is true;
attribute syn_preserve of cal_suPhClkd2 : label is true;
attribute syn_keep of cal_suClkd2 : label is true;
attribute syn_keep of cal_suPhClkd2 : label is true;
attribute syn_preserve of suPhClkDiv2 : signal is true;
attribute syn_preserve of suClkDiv2 : signal is true;
attribute syn_keep of suPhClkDiv2 : signal is true;
attribute syn_keep of suClkDiv2 : signal is true;
...
begin
  if clk0'event and clk0 = '1' then
    fpga_rst <= reset or not (dcmlocked and clk0dcmlock) after 1 ps ;
  end if;
end process;
