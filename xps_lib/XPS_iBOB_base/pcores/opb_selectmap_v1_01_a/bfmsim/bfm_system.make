...
# /home/alschult/BEE2_BSP/repository/pcores/opb_selectmap_v1_01_a/bfmsim/bfm_system.mhs
# The software specification of the system is in file :
# /home/alschult/BEE2_BSP/repository/pcores/opb_selectmap_v1_01_a/bfmsim/bfm_system.mss
...
$(WRAPPER_NGC_FILES): $(MHSFILE) __xps/platgen.opt \
	...
	@echo "****************************************************"
	platgen $(PLATGEN_OPTIONS) -st none $(MHSFILE)
...
$(SYSTEM_BIT): $(BMM_FILE) $(POSTSYN_NETLIST) __xps/xpsxflow.opt \
	...
	@echo "*********************************************"
	xflow -wd implementation -p $(DEVICE) -implement fast_runtime.opt $(SYSTEM).edn
