...
# /vol/hitz/vol2/designs/BEE/projects/henry_devel/xsg_82_uprev/XPS_iBOB_base/system.mhs
# The software specification of the system is in file :
# /vol/hitz/vol2/designs/BEE/projects/henry_devel/xsg_82_uprev/XPS_iBOB_base/system.mss
...
Software_program: $(SOFTWARE_OUTPUT) 

$(SOFTWARE_OUTPUT) : $(SOFTWARE_SOURCES) $(SOFTWARE_HEADERS) $(SOFTWARE_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/software_compiler.opt
	@mkdir -p $(SOFTWARE_OUTPUT_DIR) 
	$(SOFTWARE_CC) $(SOFTWARE_CC_OPT) $(SOFTWARE_SOURCES) -o $(SOFTWARE_OUTPUT) \
	$(SOFTWARE_OTHER_CC_FLAGS) $(SOFTWARE_INCLUDES) $(SOFTWARE_LIBPATH) \
	$(SOFTWARE_CFLAGS) $(SOFTWARE_LFLAGS) 
	$(SOFTWARE_CC_SIZE) $(SOFTWARE_OUTPUT) 
	@echo ""

Software_programclean:
	rm -f $(SOFTWARE_OUTPUT) 
