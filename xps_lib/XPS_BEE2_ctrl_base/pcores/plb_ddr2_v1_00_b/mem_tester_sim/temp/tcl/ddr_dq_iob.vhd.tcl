set output_file [open "mem_tester_sim/ddr2_controller_v1_00_a/hdl/vhdl/ddr_dq_iob.vhd" w ]
...
set line_num 8; puts $output_file "--  File name :       ddr_dq_iob.vhd"
...
set line_num 12; puts $output_file "--                    for a single data bit. The DDR input flip-flops are not used"
set line_num 13; puts $output_file "--                    since data is captured in the CLB flip-flops. "
set line_num 14; puts $output_file "--                    "
set line_num 15; puts $output_file "--  Date - revision : 07/28/2003"
set line_num 16; puts $output_file "--"
set line_num 17; puts $output_file "--  Author :          Maria George"
...
set line_num 63; puts $output_file "entity ddr_dq_iob is "
set line_num 64; puts $output_file "port ("
set line_num 65; puts $output_file "      ddr_dq_inout       : inout std_logic; --Bi-directional SDRAM data bus"
set line_num 66; puts $output_file "      write_data_falling : in std_logic;    --Transmit data, output on falling edge"
set line_num 67; puts $output_file "      write_data_rising  : in std_logic;    --Transmit data, output on rising edge"
set line_num 68; puts $output_file "      write_en_val       : in std_logic;"
set line_num 69; puts $output_file "      read_data_in       : out std_logic;   -- Received data"
set line_num 70; puts $output_file "      clk90              : in std_logic;    --Clock 90"
set line_num 71; puts $output_file "      reset              : in std_logic); "
set line_num 72; puts $output_file " --attribute xc_props of ddr_dq_inout : signal is \"IOB=TRUE\";       "
set line_num 73; puts $output_file "end ddr_dq_iob;"
set line_num 74; puts $output_file ""
set line_num 75; puts $output_file "architecture arc_ddr_dq_iob of ddr_dq_iob is"
...
set line_num 79; puts $output_file "component FDDRRSE "
set line_num 80; puts $output_file "port( Q  : out std_logic;"
set line_num 81; puts $output_file "      C0 : in std_logic;"
set line_num 82; puts $output_file "      C1 : in std_logic;"
set line_num 83; puts $output_file "      CE : in std_logic;"
set line_num 84; puts $output_file "      D0 : in std_logic;"
set line_num 85; puts $output_file "      D1 : in std_logic;"
set line_num 86; puts $output_file "      R  : in std_logic;"
set line_num 87; puts $output_file "      S  : in std_logic);"
set line_num 88; puts $output_file "end component;"
set line_num 89; puts $output_file ""
set line_num 90; puts $output_file "component FDPE "
set line_num 91; puts $output_file "port("
set line_num 92; puts $output_file "       D   : in std_logic; "
set line_num 93; puts $output_file "       PRE : in std_logic; "
set line_num 94; puts $output_file "       C   : in std_logic;"
set line_num 95; puts $output_file "       Q   : out std_logic; "
set line_num 96; puts $output_file "       CE  : in std_logic);"
set line_num 97; puts $output_file "end component;"
set line_num 98; puts $output_file ""
set line_num 99; puts $output_file "component OBUFT"
set line_num 100; puts $output_file "port ("
set line_num 101; puts $output_file "       I : in std_logic;"
set line_num 102; puts $output_file "       T : in std_logic;"
set line_num 103; puts $output_file "       O : out std_logic);"
set line_num 104; puts $output_file "end component;"
set line_num 105; puts $output_file ""
set line_num 106; puts $output_file "component IBUF"
set line_num 107; puts $output_file "port ("
set line_num 108; puts $output_file "       I : in std_logic;"
set line_num 109; puts $output_file "       O : out std_logic);"
...
set line_num 115; puts $output_file "--     Internal signal declaration"
set line_num 116; puts $output_file "--***********************************************************************/"
set line_num 117; puts $output_file "  "
set line_num 118; puts $output_file "signal ddr_en       : std_logic;  -- Tri-state enable signal"
set line_num 119; puts $output_file "signal ddr_dq_q     : std_logic;  -- Data output intermediate signal"
set line_num 120; puts $output_file "signal ddr_dq_o     : std_logic;  -- Data output intermediate signal"
set line_num 121; puts $output_file "signal GND          : std_logic;"
set line_num 122; puts $output_file "signal clock_en     : std_logic := '1';"
set line_num 123; puts $output_file "signal enable_b     : std_logic;"
set line_num 124; puts $output_file "  signal clk270       : std_logic; "
set line_num 125; puts $output_file ""
set line_num 126; puts $output_file "  attribute syn_keep of clk270  : signal is true;"
set line_num 127; puts $output_file ""
set line_num 128; puts $output_file "begin"
set line_num 129; puts $output_file ""
set line_num 130; puts $output_file "GND    <= '0';"
set line_num 131; puts $output_file "enable_b <= not write_en_val;"
set line_num 132; puts $output_file "  clk270   <= not clk90;"
set line_num 133; puts $output_file "-- Transmission data path"
set line_num 134; puts $output_file ""
set line_num 135; puts $output_file "DDR_OUT : FDDRRSE port map"
set line_num 136; puts $output_file "            (Q  => ddr_dq_q, "
set line_num 137; puts $output_file "             C0 => clk270, "
set line_num 138; puts $output_file "             C1 => clk90, "
set line_num 139; puts $output_file "             CE => clock_en,"
set line_num 140; puts $output_file "             D0 => write_data_rising, "
set line_num 141; puts $output_file "             D1 => write_data_falling, "
set line_num 142; puts $output_file "             R  => GND, "
set line_num 143; puts $output_file "             S  => GND);"
set line_num 144; puts $output_file "   "
set line_num 145; puts $output_file "DQ_T   :   FDPE port map"
set line_num 146; puts $output_file "           ( D   => enable_b, "
set line_num 147; puts $output_file "             PRE => reset, "
set line_num 148; puts $output_file "             C   => clk270, "
set line_num 149; puts $output_file "             Q   => ddr_en, "
set line_num 150; puts $output_file "             CE  => clock_en);"
set line_num 151; puts $output_file ""
set line_num 152; puts $output_file "  "
set line_num 153; puts $output_file "DQ_OBUFT : OBUFT port map"
set line_num 154; puts $output_file "             ( I => ddr_dq_q,"
set line_num 155; puts $output_file "               T => ddr_en,"
set line_num 156; puts $output_file "               O => ddr_dq_inout);"
set line_num 157; puts $output_file ""
set line_num 158; puts $output_file "-- Receive data path"
set line_num 159; puts $output_file ""
set line_num 160; puts $output_file "DQ_IBUF :  IBUF port map"
set line_num 161; puts $output_file "             ( I => ddr_dq_inout,"
set line_num 162; puts $output_file "               O => read_data_in);"
set line_num 163; puts $output_file ""
set line_num 164; puts $output_file ""
set line_num 165; puts $output_file " end arc_ddr_dq_iob;"
