...
add wave -noupdate -format logic -hex /testbench/dut/local_link/xgmac_block/tx_data
add wave -noupdate -format logic -binary /testbench/dut/local_link/xgmac_block/tx_data_valid
add wave -noupdate -format logic /testbench/dut/local_link/xgmac_block/tx_start
add wave -noupdate -format logic /testbench/dut/local_link/xgmac_block/tx_ack
# tx_underrun is tied to '0' in the example design and is minimised out
#add wave -noupdate -format logic /testbench/dut/local_link/xgmac_block/tx_underrun
...
add wave -noupdate -format logic -hex /testbench/dut/local_link/xgmac_block/rx_data
add wave -noupdate -format logic -binary /testbench/dut/local_link/xgmac_block/rx_data_valid
add wave -noupdate -format logic /testbench/dut/local_link/xgmac_block/rx_good_frame
add wave -noupdate -format logic /testbench/dut/local_link/xgmac_block/rx_bad_frame
