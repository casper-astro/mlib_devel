...
class ltc2308(YellowBlock):
    ...
    def initialize(self):
        ...
        self.add_source('adc_ltc2308_fifo.v')
        self.add_source('adc_ltc2308.v')
        # If adc_ltc2308_fifo.v depends on other RTL, add them here too:
        # self.add_source('adc_data_fifo.v')
    ...
    def modify_top(self, top):
        ...
        u.add_port('ADC_CONVST', 'ADC_CONVST', dir='out')
        u.add_port('ADC_SCK',    'ADC_SCK',    dir='out')
        u.add_port('ADC_SDI',    'ADC_SDI',    dir='out')
        u.add_port('ADC_SDO',    'ADC_SDO',    dir='in')
