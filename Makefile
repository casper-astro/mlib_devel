...
LIBS := hello_world_bsp/microblaze_0/lib/libxil.a
EXEC := executable.elf

INCLUDEPATH := -Ihello_world_bsp/microblaze_0/include -I.
LIBPATH := -Lhello_world_bsp/microblaze_0/lib
